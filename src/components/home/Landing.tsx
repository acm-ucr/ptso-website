...
const Landing = () => {
  return (
    <div className="bg-ptso-blue-primary relative overflow-hidden">
      {/* Decorative Stars in Flex Row */}
      <div className="absolute top-[8rem] right-0 left-0 z-10 flex justify-between px-8">
        <Image src={whitediamond} alt="star1" className="mt-60 w-16" />
        <Image
          src={purplediamond}
          alt="star1.5"
          className="mt-55 -ml-95 w-10"
        />
        <Image src={purplediamond} alt="star2" className="-mt-20 -ml-50 w-16" />
